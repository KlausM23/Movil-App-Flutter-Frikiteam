  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0XFF65295F),
      ),
      ...
      Find Events is licensed to You (End-User) by FrikiTeam, located and registered at Av Alameda San Marcos 11, Chorrillos 15067, Lima. Peru, Lima, Peru, Chorrillos 51, Peru ("Licensor"), for use only under the terms of this License Agreement.
      ...
      The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. FrikiTeam, not the Services, is solely responsible for the Licensed Application and the content thereof.
      
      This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Google Play Terms of Service ("Usage Rules"). FrikiTeam acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.
      
      Find Events when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Find Events is to be used on devices that operate with Google's operating system ("Android").
      ...
      Find Events ("Licensed Application") is a piece of software created to Brindar facilidad a aquellas personas interesadas en asistir a los diversos eventos, ya que, por lo general, buscarlos por internet u otros medios resulta complicado, puesto que muchas de las páginas están desactualizadas o tienen una interfaz muy poco amigable con el usuario final. Además, de que los organizadores de eventos no poseen un lugar adecuado donde publicar sus eventos, razón por la cual lo hacen a través de redes sociales, ocasionando que a los usuarios frikis se les dificulta al momento de localizarlos — and customized for Android mobile devices ("Devices"). It is used to Encontrar una variedad de eventos, pertenecientes a la categoría “friki”. Esta plataforma consistirá en un “buscador de eventos, que proporciona una lista de eventos, ubicación y fechas. Además, brindara la posibilidad de adquirir las entradas”. .
      ...
      2.3  You may not share or make the Licensed Application available to third parties (unless to the degree allowed by the Usage Rules, and with FrikiTeam's prior written consent), sell, rent, lend, lease or otherwise redistribute the Licensed Application.
      
      2.4  You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with FrikiTeam's prior written consent).
      ...
      4.2  FrikiTeam and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.
      ...
      8.2  No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of FrikiTeam's sphere of influence that affect the executability of the Licensed Application.
      
      8.3  You are required to inspect the Licensed Application immediately after installing it and notify FrikiTeam about issues discovered without delay by email provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been emailed within a period of sixty (60) days after discovery.
      
      8.4  If we confirm that the Licensed Application is defective, FrikiTeam reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
      ...
      FrikiTeam and the End-User acknowledge that FrikiTeam, and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User’s possession and/or use of that Licensed Application, including, but not limited to:
      ...
      FrikiTeam
      Av Alameda San Marcos 11, Chorrillos 15067
      Lima. Peru, Lima, Peru, Chorrillos 51
      Peru
      infoFrikiTeam@friki.pe
      
      
      12. TERMINATION
      
      The license is valid until terminated by FrikiTeam or by You. Your rights under this license will terminate automatically and without notice from FrikiTeam if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.
          
      
      13. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY
      
      FrikiTeam represents and warrants that FrikiTeam will comply with applicable third-party terms of agreement when using Licensed Application.
      ...
      FrikiTeam and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, FrikiTeam, and not the Services, will be solely responsible for the investigation, defense, settlement, and discharge or any such intellectual property infringement claims.
      
      
      15. APPLICABLE LAW
      
      This License Agreement is governed by the laws of Peru excluding its conflicts of law rules.
